...
resource "aws_vpc" "main" {
  ...
  # Security: Disable default network ACL
  # We'll create custom NACLs explicitly
...
resource "aws_subnet" "public" {
  ...
  # Security: Don't auto-assign public IPs
...
resource "aws_subnet" "private" {
  ...
  # Security: Private subnets should never auto-assign public IPs
  map_public_ip_on_launch = false
...
resource "aws_network_acl" "private" {
  ...
  # Ingress: Allow traffic from VPC
  ingress {
    protocol   = -1
    rule_no    = 100
    action     = "allow"
